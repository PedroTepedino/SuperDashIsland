	...
	Category 
	{
		SubShader
		{
			...
			Pass {
				...
				ASE_DECLARE_SCREENSPACE_TEXTURE( GrabScreen0 )
				...
				fixed4 frag ( v2f i  ) : SV_Target
				{
					...
					float2 uv091 = i.texcoord.xy * float2( 1,1 ) + appendResult112;
					float4 screenColor27 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(GrabScreen0,( ase_grabScreenPosNorm + float4( ( UnpackNormal( tex2D( _TextureSample0, uv091 ) ) * _HazeNormalIntensity ) , 0.0 ) ).xy/( ase_grabScreenPosNorm + float4( ( UnpackNormal( tex2D( _TextureSample0, uv091 ) ) * _HazeNormalIntensity ) , 0.0 ) ).w);
...
/*ASEBEGIN
Version=17101
7;1;2546;1010;-390.7689;118.0078;1;True;True
Node;AmplifyShaderEditor.RangedFloatNode;97;-1060.256,596.4069;Float;False;Property;_HazeHFreq;HazeHFreq;3;0;Create;True;0;0;False;0;0;10;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;42;-1092.361,749.8011;Float;False;Property;_HazeVSpeed;HazeVSpeed;0;0;Create;True;0;0;False;0;0;0.1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleTimeNode;101;-866.9058,625.057;Inherit;False;1;0;FLOAT;10;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;98;-1008.256,404.4069;Float;False;Property;_HazeHAmp;HazeHAmp;5;0;Create;True;0;0;False;0;0;0.005;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;71;148.1356,688.5034;Inherit;True;Property;_TextureSample0;Texture Sample 0;2;0;Create;True;0;0;False;0;None;24e31ecbf813d9e49bf7a1e0d4034916;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;73;174.0337,897.8049;Float;False;Property;_HazeNormalIntensity;HazeNormalIntensity;4;0;Create;True;0;0;False;0;0.1;0.1364113;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ScreenColorNode;27;849.1401,398.602;Float;False;Global;GrabScreen0;Grab Screen 0;0;0;Create;True;0;0;False;0;Object;-1;True;True;1;0;FLOAT4;0,0,0,0;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TemplateShaderPropertyNode;46;816.9399,672.4011;Inherit;False;0;0;_TintColor;Shader;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;50;1230.135,1087.298;Inherit;True;Property;_HazeMask;HazeMask;1;0;Create;True;0;0;False;0;None;0000000000000000f000000000000000;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=D1262F58EE2DC77AD49C1194469BA53CF8F52A7F