...
Shader "Toony Colors Pro 2/User/My TCP2 Shader"
{
	Properties
	{
		...
		[TCP2Gradient] _RampPoint			("Ramp Texture (Point)", 2D) = "gray" {}
		[TCP2Gradient] _RampSpot				("Ramp Texture (Spot)", 2D) = "gray" {}
		[TCP2Gradient] _RampDir				("Ramp Texture (Directional)", 2D) = "gray" {}
	...
	SubShader
	{
		...
		#pragma surface surf ToonyColorsCustom vertex:vertex_surface exclude_path:deferred exclude_path:prepass keepalpha noshadow nolightmap nofog nolppv
		#pragma target 3.0
