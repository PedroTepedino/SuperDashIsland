...
Shader "Toony Colors Pro 2/User/CellFloor"
{
	Properties
	{
		[TCP2HeaderHelp(Base)]
	...
	SubShader
	{
		...
		#pragma surface surf ToonyColorsCustom vertex:vertex_surface exclude_path:deferred exclude_path:prepass keepalpha fullforwardshadows nolightmap nofog nolppv
		#pragma target 3.0
...
/* TCP_DATA u config(ver:"2.4.2";tmplt:"SG2_Template_Default";features:list["UNITY_5_4","UNITY_5_5","UNITY_5_6","UNITY_2017_1","UNITY_2018_1","UNITY_2018_2","UNITY_2018_3","RAMP_MAIN_OTHER","RAMP_SEPARATED","SHADOW_HSV","SHADOW_HSV_MASK","OCCLUSION","TEXTURE_RAMP"];flags:list["fullforwardshadows"];keywords:dict[RENDER_TYPE="Opaque",RampTextureDrawer="[TCP2Gradient]",RampTextureLabel="Ramp Texture",SHADER_TARGET="3.0"];shaderProperties:list[];customTextures:list[]) */
/* TCP_HASH 46363e1ce8fe15bce4895f93c5dab008 */
